    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item" style="padding: 10px;">
            <a class="nav-link" href="<?= base_url('admin'); ?>">
                <i class="fas fa-fw fa-tachometer-alt" style="font-size: 20px;  color: #202C60;"></i>
                <span style="font-size: 20px;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;letter-spacing: 2px; padding-left: 10px;  color: #202C60;">Dashboard</span></a>
        </li>
        ...
        <li class="nav-item" style="background-color:#1C75AE;color:white;border-radius:5px">
            <a class="nav-link" href="<?= base_url('slider'); ?>" style="background-color:#1C75AE;color:white;border-radius:5px">
                <i class="fas fa-fw fa-sliders-h" style="font-size: 20px; padding-left: 10px;"></i>
                <span style="font-size: 20px;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;letter-spacing: 2px; text-align: center; padding-left: 20px;">Slider</span></a>
        </li>
