<div class="container">
    ...
    <div class="row justify-content-around">
        <div>
            <img src=" assets/img/icon/sekolah_undraw.png" height="250px" style="margin-top: 64%;">
        </div>
        <div class="col-lg-6" style="padding-top: 50px; margin-top: -60px;">
                ...
                <form class="user" method="post" action="<?= base_url('login'); ?>" style="padding-top: 50px;">
                    <div class="card" style="background-color: white;">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-title" style="color: black; font-size: 20px; font-family: 'Poppins', sans-serif; text-align: center; font-weight: 500;">Login</h6>
                            ...
                            <div class="form-group">
                                <button class="btn btn-outline-success btn-user btn-block" type="submit" style="font-family: 'Poppins', sans-serif; font-size: 15px; border-radius: 10px;">Masuk Sekarang!</button><br>
                            </div>
                        </div>
                    </div>
                </form>
